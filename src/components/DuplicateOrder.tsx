...
import { query, collection, getDocs, where, orderBy, limit, setDoc, getDoc, } from "firebase/firestore"
...
const DuplicateOrder = () => {
    ...
    // const importOriginalFromFirebase = (initialOrderId) => {
    //     try {
    //         getDoc(doc(db, "orders", initialOrderId))
    //         .then(() => {
